$(document).ready(function(){
    ...
    function rememberTag() {
        ...
        newButton.on("click", function(){
            ...
            var queryUrl = "api.openweathermap.org/data/2.5/forecast?q=" + cityPlace + "d9b982ad5fa0b2cf1cde8f25b68f4d35";
            ...
            tag.on("click", function(){
                ...
                $.ajax({
                    ...
                    $.ajax({
                        ...
                        var queryForcast = "api.openweathermap.org/data/2.5/forecast?q={city name}&appid={API key}" + cityName + "d9b982ad5fa0b2cf1cde8f25b68f4d35";
